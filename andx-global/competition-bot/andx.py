...
class AndxClient:
    def __init__(self, api_key="", api_secret="", session_jwt="", **_ignored):
        self.api_key = api_key
        self.api_secret = api_secret
        # session_jwt: an already-authenticated ANDX app session token. When
        # the bot runs inside the ANDX app, the app passes the user's own
        # session instead of API keys — no key creation, no signin call.
        # The app is responsible for renewal (reconnect with a fresh token).
